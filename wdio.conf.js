exports.config = {
    ...
    //
    specs: [
        './test/test_web/test_testing/specs/**/*.js'
    ],
    // Patterns to exclude.
    exclude: [
    ...
    capabilities: [{
        ...
        outputDir: './logs', // to suppress logs from console
        // it is possible to configure which logTypes to include/exclude.
        // excludeDriverLogs: ['*'], // pass '*' to exclude all driver session logs
        // excludeDriverLogs: ['bugreport', 'server'],
        "goog:chromeOptions": {
            // args: ['disable-infobars', '--headless', '--window-size=1920,1080', '--incognito'],
            args: ['disable-infobars', '--window-size=1600,900', '--incognito'],
          },
    }],
    //
    // ===================
    ...
    baseUrl: 'https://node-fs-app.herokuapp.com',
    //
